INSERT INTO AIRPORT (city, iata_code) VALUES ('Нижний Новгород', 'GOJ' );
...
*/
INSERT INTO SCHEDULE (flight, arrival, departure, lane_id, airport_id) VALUES ('ЮТ 351', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()+1, @LANEID1, @AIRPORTID);